...
export function Landing() {
  ...
  const { setProfile, setIsDemo } = useApp();
    ...
    <>
      <section className="hero">
        <div>
          ...
          <p className="hero-sub">
            EstuRoad te ayuda a descubrir qué estudiar considerando de dónde vienes, qué te mueve y
            qué oportunidades reales tienes —quedándote o migrando— en Colombia.
          </p>
        ...
        <div className="hero-visual">
          ...
          <div className="hv-bottom">
            ...
            <div className="hv-cap">
              Analizamos empleabilidad, salario y demanda en tu región vs. las grandes ciudades para
              que decidas con argumentos.
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="strip">
        {[
          ...
          'Test RIASEC adaptado',
          'Universidades públicas y privadas',
          'Becas ICETEX',
          'Técnicas y tecnológicas',
          'Quedarse o migrar',
        ].map((t) => (
          <div key={t} className="strip-item">
            {t}
          </div>
        ))}
      </section>
      ...
      <section className="section">
        <div className="section-head">
          <h2>
            Un test vocacional
            <br />
            que entiende Colombia.
          </h2>
          <p className="section-lede">
            La mayoría de tests te dicen qué eres. EstuRoad además te dice dónde tiene sentido
            serlo, cuánto cuesta, y qué oportunidades hay sin que tengas que irte.
          </p>
        </div>
        <div className="why">
          <div className="why-card span-5 dark">
            ...
            <h3>
              Quedarte en tu ciudad
              <br />
              también es una opción.
            </h3>
            <p>
              Para cada carrera te mostramos oportunidades en tu región antes de asumir que tienes
              que migrar a Bogotá o Medellín.
            </p>
          </div>
          <div className="why-card span-4 lime">
            ...
            <p>
              Filtramos carreras viables según lo que tu familia puede pagar, incluyendo
              universidades públicas y ICETEX.
            </p>
          </div>
          <div className="why-card span-3 terra">
            <span className="mono">03</span>
            <div>
              <div className="why-num">8 min</div>
              <p>Test RIASEC adaptado al contexto colombiano.</p>
            </div>
          </div>
          ...
          <div className="why-card span-4">
            ...
            <p>
              Pon dos o tres carreras lado a lado: costo, duración, empleabilidad, sin filtros
              comerciales.
            </p>
          </div>
        </div>
          ...
          <div className="cta-grid">
            <div>
              ...
              <p className="cta-body">
                Responde 20 preguntas y en 8 minutos tendrás un perfil con tus 5 mejores caminos,
                detalle por carrera, costos y un mapa de oportunidades en Colombia.
              </p>
              <div className="cta-actions">
                <button type="button" className="btn lime" onClick={() => navigate('/perfil')}>
                  Hacer el test →
                </button>
                <button type="button" className="btn ghost light" onClick={loadDemo}>
                  Ver demo
                </button>
              </div>
            </div>
