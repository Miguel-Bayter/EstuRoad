...
export function scoreCarrera(carrera: Carrera, perfil: Perfil): number {
  ...
  // Interests match (max +20, capped to avoid inflation)
  ...
  // Habilidades match (max +10) — uses real API field when available
  ...
  // School subjects alignment (max +8)
